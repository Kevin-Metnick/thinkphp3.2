	...
	<div id="wrapper">
		...
		<div id="page">
			<div id="content">
				...
				<h1>Stylings / Contact Form &amp; Buttons</h1>
				
				<div class="hr"></div>
				
				<!-- CONTACT FORM -->
				<form action="#" id="page_contact_form" method="post">
				<ul class="page_contact_form">
					<li>
						<input type="text" id="cf1" name="cf_name" />
						<label>Name</label>
					</li>
					<li>
						<input type="text" id="cf2" name="cf_email" /><label>Email</label>
					</li>
					<li>
						<textarea rows="" cols="" id="cf3" name="cf_msg" class="required"></textarea>
					</li>
					<li>
						<input type="text" id="cf4" name="cf_captcha" class="required" maxlength="4" /><img alt="" id="captcha" src="/Public/captcha.php" />
						<label>Enter the characters</label>
					</li>
					<li id="cf_btn">
						<input class="send_button" type="submit" value="OK" />
					</li>
				</ul>
				</form>
				...
				<!-- BUTTONS -->
				<a href="#" class="button-small" style="">I'm a Button</a><br />
				<a href="#" class="button-medium" style="">I'm a Button</a><br />
				<a href="#" class="button-large" style="">I'm a Button</a><br />
				<a href="#" class="button-large" style="background-color: #6800b0; color: #fff;">Color Button</a>
