				...
				<ul class="blog-medium">
					<li>			
						<div class="blog-medium-image">
							<a href="post.html"><span class="imghover_medium_blog"></span><img src="/Public/images/post1-med.jpg" alt="" /></a>
						</div>
						...
						<div class="blog-medium-text">		
							<p class="blog-info"><img src="/Public/images/icon-time.png" alt="" />March 14, 2012 
							<img src="/Public/images/sep.gif" alt="" /><img src="/Public/images/icon-comment.png" alt="" />0 Comment(s)
							</p>
						</div>
					</li>	
					...
					<li>			
						...
						<div class="blog-medium-text">		
							<p class="blog-info"><img src="/Public/images/icon-time.png" alt="" />February 22, 2012 
							<img src="/Public/images/sep.gif" alt="" /><img src="/Public/images/icon-comment.png" alt="" />7 Comment(s)
							</p>
						</div>
					</li>	
					...
					<li>			
						...
						<div class="blog-medium-text">		
							<p class="blog-info"><img src="/Public/images/icon-time.png" alt="" />January 28, 2012 
							<img src="/Public/images/sep.gif" alt="" /><img src="/Public/images/icon-comment.png" alt="" />26 Comment(s)
							</p>
						</div>
					</li>	
					...
					<li>			
						...
						<div class="blog-medium-text">		
							<p class="blog-info"><img src="/Public/images/icon-time.png" alt="" />January 14, 2012 
							<img src="/Public/images/sep.gif" alt="" /><img src="/Public/images/icon-comment.png" alt="" />0 Comment(s)
							</p>
						</div>
					</li>	
