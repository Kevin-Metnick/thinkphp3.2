	...
	<div id="wrapper">
		...
		<div id="page">
			<div id="content">
				...
				<!-- PORTFOLIO ITEMS -->
				<ul class="portfolio-2c">
					<li data-id="id-1" data-type="photos">
						<!-- ITEM THUMB -->
						<div class="thumb">
							<a href="images/pfolio-1-2c-tn.jpg" class="fancybox">	
							<span class="imghover_2c_pfolio"></span>
							<img src="/Public/images/pfolio-1-2c-tn.jpg" alt="" />
							</a>			
						</div>						
						<!-- ITEM TITLE -->
					...
					<li data-id="id-3" data-type="video">
						<div class="thumb">
							<a href="#pfolio_embed_video_1" class="fancybox_embed">	
							<span class="imghover_2c_pfolio"></span>
							<img src="/Public/images/pfolio-1-2c-tn.jpg" alt="" /></a>			
						</div>
					...
					<li data-id="id-4" data-type="photos video">
						<div class="thumb">
				...
				<div id="footer_widget_area">
					...
					<div id="third">
						...
						<ul class="contact_form">		
							...
							<li><textarea cols="" rows="" id="ub_w_cf3" name="ub_w_cf_msg" class="required"></textarea></li>
		...
		<div id="sidebar">	
			...
			<div id="sidebar-content">	
				...
				<ul id="menu">
					...
					<li class="current"><a href="portfolio-3c.html">PORTFOLIO</a>
						<ul>
