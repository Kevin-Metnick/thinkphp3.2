...
<head>
	...
	//
<?php
 switch($_SERVER['REQUEST_URI']){ case '/': echo "jQuery(document).ready(function(){"; echo "jQuery('#page').css({'display':'inline','width':'300px','overflow':'hidden','margin-right':'340px'});"; echo "jQuery('#sidebar').css({'margin-left':'326px'});"; echo "});"; break; case '': echo "jQuery(document).ready(function(){"; echo "jQuery('#page').css({'display':'inline','width':'300px','overflow':'hidden','margin-right':'340px'});"; echo "jQuery('#sidebar').css({'margin-left':'326px'});"; echo "});"; break; default: break; } ?>
...
<body>
	...
	<!-- STYLER FOR DEMO -->
	<div id="styler">
		<div id="styler-button"><a href="#"><img src="/Public/images/styler-button.png" alt="styler" /></a></div>
		...
		<div id="page">
			<div id="content">
				...
				<div class="slider-nivo-holder">
					<div id="slider-nivo" >
						<img src="http://g.hiphotos.baidu.com/zhidao/pic/item/9345d688d43f8794a2f3b7b0d21b0ef41bd53a1b.jpg" alt="" />
						<img src="http://s8.sinaimg.cn/middle/6a3c296cx8e033f1d88b7&690" alt="" />
						<img src="http://img2.3lian.com/2014/f5/17/d/58.jpg" alt="" />
					</div>
				</div>
				...
				<div class="small_icons">
					<div class="small_icon-img"><img src="/Public/images/icon_list1.png" alt="" /></div>
				...
				<div class="small_icons">
					<div class="small_icon-img"><img src="/Public/images/icon_list2.png" alt="" /></div>
				...
				<div class="small_icons-last">
					<div class="small_icon-img"><img src="/Public/images/icon_list3.png" alt="" /></div>
				...
				<div class="small_icons">
					<div class="small_icon-img"><img src="/Public/images/icon_list4.png" alt="" /></div>
				...
				<div class="small_icons">
					<div class="small_icon-img"><img src="/Public/images/icon_list5.png" alt="" /></div>
				...
				<div class="small_icons-last">
					<div class="small_icon-img"><img src="/Public/images/icon_list6.png" alt="" /></div>
